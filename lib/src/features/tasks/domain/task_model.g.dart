...
void _taskModelSerialize(
  ...
  writer.writeLong(offsets[5], object.linkedEventId);
...
TaskModel _taskModelDeserialize(
  ...
  object.linkedEventId = reader.readLongOrNull(offsets[5]);
...
extension TaskModelQueryWhere
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> categoryEqualTo(
      String category) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> categoryNotEqualTo(
      String category) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
